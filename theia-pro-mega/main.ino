...
const unsigned short CRADLE_OPEN_SENSOR = 12;  // BLUE
const unsigned short CRADLE_CLOSE_SENSOR = 11; // GREEN
const unsigned short CRADLE_OPEN_MOTOR = 10;   // PINK
const unsigned short CRADLE_CLOSE_MOTOR = 9;   // WHITE
